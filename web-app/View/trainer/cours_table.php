    ...
    ?>
     <tr>
      ...
      <td><?php 
              ...
              echo $trainer_id;
              ?></td>  
        <td><a href="update_cours.php?cr_id=<?php echo $row['cour_id'] ?>&tr_id=<?=$trainer_id ?>" <?php 
        ...
        <td><a href="../../Controller/trainer/delete_data.php?cr_id=<?php echo $row['cour_id'] ?>&tr_id=<?=$trainer_id ?>"<?php
       if($_SESSION['trainer_id']==$trainer_id){
...
<!-- Modal -->
<form action="../../Controller/trainer/insert_data.php" method="post">
