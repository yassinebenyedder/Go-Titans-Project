...
<form action="../../Controller/trainer/update_profile.php?id_new=<?php echo $id ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" minlength="10" value="<?php echo $_SESSION['email'];?>">
        </div>
