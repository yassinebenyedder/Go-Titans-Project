            ...
            <li class="nav-item dropdown">
              ...
              if(isset($_SESSION['userlogedin'])){
                if($_SESSION['userlogedin']=="client"){
                  ...
                  echo '<a class="dropdown-item" href="../log_in_system/logout.php">Déconnexion</a>';
                }elseif($_SESSION['userlogedin']=="admin"){
...
if(isset($_GET["message_success"])){
  echo"<div class='alert alert-success'>".$_GET["message_success"]."</div>";
    ...
    ?>
    <div class="container" >
<button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#exampleModal">Ajouter Cours</button>
</div>
    ...
    ?>
     <tr>
      ...
      <td><?php echo $row['trainer_id']?></td>
        <td><a href="update_cours.php?id=<?php echo $row['cour_id'] ?>" class="btn btn-success">Mise à jour</a></td>
        <td><a href="../../Controller/admin/delete_cours.php?id=<?php echo $row['cour_id'] ?>" class="btn btn-danger">Supprimer</a></td>
     </tr>
<?php
    }
?>
...
<form action="../../Controller/admin/insert_cours.php" method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nomcour">
        </div>
        <div class="form-group">
            <label >Jour</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="maximale">
        </div>
        <div class="form-group">
            <label>Trainer</label>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-success" name="ajouter-cours">
      </div>
    </div>
  </div>
</div>
