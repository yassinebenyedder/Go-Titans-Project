...
<body class="bgcolor">
    ...
    <div class="card mb-3 mr-3 ml-3 mt-2">
    <?php
if(isset($_GET["message_error"])){
  echo"<div class='alert alert-danger'>".$_GET["message_error"]."</div>";
}
if(isset($_GET["message_success"])){
  ...
  <div class="card-body">
    ...
    <p class="card-text"><strong>ID : <?php echo $_SESSION['admin_id']; ?></strong></p>
...
<button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#exampleModal">Ajouter user</button>
</div>
<div class="container">
<?php
if(isset($_GET["message_alert_table"])){
  echo"<div class='alert alert-danger'>".$_GET["message_alert_table"]."</div>";
}
if(isset($_GET["message_success_table"])){
  echo"<div class='alert alert-success'>".$_GET["message_success_table"]."</div>";
}
    ?>
...
<tbody>
<?php
// Include the class users_c
include_once "../../Controller/admin/users.php";
// Create an instance
$instance = new users_c();
$result = $instance->lister_users_c();
while($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td><a href='update_user.php?id=" . $row['user_id'] . "' class='btn btn-success'>Mise à jour</a></td>";
    echo "<td><a href='../../Controller/admin/delete_user.php?id=" . $row['user_id'] . "' class='btn btn-danger'>Supprimer</a></td>";
    echo "</tr>";
}
?>
</tbody>
...
<!-- Modal -->
<form action="../../Controller/admin/insert_user.php" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" name="nom" minlength="4">
        </div>
        <div class="form-group">
            <label for="email">Email</label>
            <input type="email" class="form-control" name="email" minlength="8">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="type" id="type" pattern="trainer|client|admin" title="Enter 'trainer' or 'client' or 'admin'">
        </div>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-success" name="ajouter-utilisateur">
      </div>
    </div>
  </div>
</div>
