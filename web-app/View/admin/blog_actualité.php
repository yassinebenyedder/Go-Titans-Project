        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <?php
              ...
              <a class="nav-link" href="blog_actualité.php">Blog/Actualité</a> </li>';
...
?>
      <div class="card-group mb-3 mr-2 ml-2 mt-2">
        <div class="card">
...
while($row = mysqli_fetch_assoc($result)) {
    ...
    $formattedContent = wordwrap($articleContent, 90, "<br>");
    // Display the formatted content on the website
    echo "<td>" . $formattedContent . "</td>";
    echo "<td><a href='update_blog.php?id=" . $row['article_id'] . "' class='btn btn-success'>Mise à jour</a></td>";
    echo "</tr>";
}
?>
</tbody>
