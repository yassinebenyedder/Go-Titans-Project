...
<body>
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../acceuil.php"><img src="..\img\logo.png" class="logo" height="50px" widrh="50px">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item"><a class="nav-link" href="#">Blog/Actualité</a></li>
            <li class="nav-item">
...
?>
      <div class="card-group mb-2 mr-3 ml-3">
        <div class="card">
