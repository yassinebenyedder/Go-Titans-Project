...
if(isset($_GET["message_success"])){
  ...
  <div class="card-body">
    ...
    <p class="card-text"><strong>ID : <?php echo $_SESSION['client_id']; ?></strong></p>
...
<tbody>
<?php
include "../../Controller/client/already_registred_table.php";
$instance = new registred_cours_cl_c();
$result = $instance->lister_rcours_c();
    ...
    ?>
     <tr>
        ...
        <td>
          <?php
            $id_t = $row['trainer_id'];
            $name=$instance->view_trainer_namee($id_t);
            echo $name; ?>
        </td>
      </tr>
<?php
          ...
          <?php
              if(isset($_SESSION['userlogedin'])){
                if($_SESSION['userlogedin']=="client"){
                  ...
                  echo '<p><a class="text-reset" href="../admin/tablaux_cour.php">rejoignez nos cours ici.</a></p>';
                }
              }
              ?>
          <p>
